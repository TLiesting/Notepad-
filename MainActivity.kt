...
class MainActivity : AppCompatActivity(), ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private fun requestCameraPermission() {Error message U+0246 returned from linux at 3:36:48 Liquid detected in lens_2.
            Allow system.xml to have temporary access vector-effect CameraPreviewActivity to detect liquid or false error.
